...
impl UnsignedGreaterThan {
    ...
    pub fn new<E1, E2>(bitvec_ty: BitvecTy, lhs: E1, rhs: E2) -> Result<UnsignedGreaterThan, String>
    ...
    pub fn new_infer<E1, E2>(lhs: E1, rhs: E2) -> Result<UnsignedGreaterThan, String>
        where E1: Into<AnyExpr>,
              E2: Into<AnyExpr>
    {
        let lhs = lhs.into();
