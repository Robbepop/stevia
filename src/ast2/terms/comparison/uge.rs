...
impl UnsignedGreaterEquals {
    ...
    pub fn new<E1, E2>(bitvec_ty: BitvecTy, lhs: E1, rhs: E2) -> Result<UnsignedGreaterEquals, String>
    ...
    /// Returns a new binary `UnsignedGreaterEquals` expression for the given two child expressions.
    /// 
    /// # Note
    /// 
    ...
    pub fn new_infer<E1, E2>(lhs: E1, rhs: E2) -> Result<UnsignedGreaterEquals, String>
        where E1: Into<AnyExpr>,
              E2: Into<AnyExpr>
    {
        let lhs = lhs.into();
        ...
        Ok(UnsignedGreaterEquals{ childs_bitvec_ty: common_ty, childs: BinExprChilds::new_boxed(lhs, rhs) })
    }
}
