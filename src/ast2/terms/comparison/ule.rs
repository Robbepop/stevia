...
impl UnsignedLessEquals {
    ...
    pub fn new<E1, E2>(bitvec_ty: BitvecTy, lhs: E1, rhs: E2) -> Result<UnsignedLessEquals, String>
    ...
    /// Returns a new binary `UnsignedLessEquals` expression for the given two child expressions.
    /// 
    /// # Note
    /// 
    ...
    pub fn new_infer<E1, E2>(lhs: E1, rhs: E2) -> Result<UnsignedLessEquals, String>
        where E1: Into<AnyExpr>,
              E2: Into<AnyExpr>
    {
        let lhs = lhs.into();
        ...
        Ok(UnsignedLessEquals{ childs_bitvec_ty: common_ty, childs: BinExprChilds::new_boxed(lhs, rhs) })
    }
}
