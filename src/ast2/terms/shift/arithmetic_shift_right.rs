...
impl ArithmeticShiftRight {
    ...
    pub fn new<E1, E2>(bitvec_ty: BitvecTy, lhs: E1, rhs: E2) -> Result<ArithmeticShiftRight, String>
    ...
    /// Returns a new binary `ArithmeticShiftRight` expression for the given two child expressions.
    /// 
    /// # Note
    /// 
    ...
    pub fn new_infer<E1, E2>(lhs: E1, rhs: E2) -> Result<ArithmeticShiftRight, String>
        where E1: Into<AnyExpr>,
              E2: Into<AnyExpr>
    {
        let lhs = lhs.into();
        ...
        Ok(ArithmeticShiftRight{ bitvec_ty: common_ty, childs: BinExprChilds::new_boxed(lhs, rhs) })
    }
}
